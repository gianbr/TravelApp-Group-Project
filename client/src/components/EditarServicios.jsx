...
export default function EditarServicios() {
  ...
  const [imageText, setImageText] = useState("Presione para agregar imagen al carrusel de imagenes");
  ...
  const uploadImage = async (e) => {
    ...
    console.log("imagen antes de convert: ", file);
                    ...
                    return (
                      <div className="text-center px-2" key={day}>
                        <input
                          ...
                          id={day}
                          name={day}
                          checked={plain?.date?.includes(day.toLocaleLowerCase())}
                          onChange={(e) => {
                            handleDiasChecked(e);
                          }}
                        />

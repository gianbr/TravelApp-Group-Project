  ...
  return (
    <div className="relative w-full h-screen bg-zinc-900/90">
      ...
      <div className="flex flex-col justify-evenly items-center h-full">
        <Link to="/" className="rounded-2xl py-2 p-3 focus:outline-none focus:ring focus:ring-indigo-500 bg-teal-400 hover:bg-indigo-500 relative text-white font-semibold">
        ...
        <form className="max-w-[400px] w-full mx-auto bg-white p-8">
          ...
          <div onClick={handleSubmit}>
            <button type="submit" className="w-full py-3 mt-8 bg-teal-400 hover:bg-indigo-500 relative text-white">
              Inicia Sesion
            </button>
          </div>
          ...
          <div>
            <Link to="/register">
              <button type="submit" className="w-full py-3 mt-8 bg-transparent relative text-black">
